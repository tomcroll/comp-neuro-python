...
# omit 2.69 estimate as outside of firing distribution
thresh_test = [5.830, 5.667, 5.978]

opt_thresh = compute_costed_threshold(
    weight, thresh_test, meanS1, sdS1, meanS2, sdS2)
...
plt.plot(opt_thresh, 0.24, 'o', color='purple')
